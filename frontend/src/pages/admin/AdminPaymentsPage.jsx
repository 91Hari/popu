    ...
    <AppLayout>
      <Container maxWidth="lg" sx={{ pt: 3, pb: 5 }}>
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 1.5, mb: 3 }}>
          <PaymentsRoundedIcon sx={{ color: brand.orange, fontSize: 28 }} />
          <Box>
            <Typography variant="h5" sx={{ fontWeight: 800 }}>Payments</Typography>
            <Typography variant="body2" sx={{ color: "text.secondary" }}>
              All PhonePe online payment transactions
            </Typography>
          </Box>
        </Box>
                  ...
                  {rows.map((p) => (
                    <TableRow key={p.id} hover>
                      ...
                      <TableCell>
                        ...
                        <Typography variant="caption" sx={{ color: "text.secondary" }}>{p.customer_email}</Typography>
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell>
                        <Typography variant="caption">{p.payment_method || "—"}</Typography>
                      </TableCell>
                      <TableCell>
                        <Chip
                          label={p.payment_status}
                          color={STATUS_COLORS[p.payment_status] || "default"}
                          size="small"
                      ...
                      <TableCell>
                        {p.master_order_id
                          ? <Typography variant="caption" sx={{ fontFamily: "monospace" }}>
                              #{p.master_order_id.slice(0, 8).toUpperCase()}
                            </Typography>
